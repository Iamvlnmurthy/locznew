...
const CATEGORIES: CategorySeed[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        // No model list here on purpose. Nobody shops for a "Whirlpool WDE205 CLS 3S" —
        // they want a 1.5 ton five-star split AC from a brand they recognise. Capacity,
        // type and star rating are the filters that do the work; the model number belongs
        // in the title, where search already finds it.
        attributes: [
          {
            key: 'brand',
            label: 'Brand',
            ...
            options: [
              ...
              { value: 'BLUE_STAR', label: 'Blue Star' },
              ...
              // Every picklist here ends the same way. A brand list is out of date the day
              // it ships, and a seller who cannot name what they own simply does not post.
          ...
          },
          {
            ...
            options: [
              ...
              { value: 'FAN', label: 'Fan' },
              { value: 'MIXER_GRINDER', label: 'Mixer / grinder' },
              { value: 'DISHWASHER', label: 'Dishwasher' },
              { value: 'CHIMNEY', label: 'Chimney' },
              { value: 'INDUCTION', label: 'Induction / gas stove' },
          ...
          },
          {
            ...
            label: 'Screen size',
            labelTe: 'స్క్రీన్ పరిమాణం',
            labelHi: 'स्क्रीन आकार',
            dataType: AttributeDataType.NUMBER,
            unit: 'inches',
            isFilterable: true,
          },
          {
            ...
            labelTe: 'సామర్థ్యం',
            labelHi: 'क्षमता',
            // Free text rather than a number, because the unit differs by appliance: litres
            // for a fridge, kilograms for a washing machine, tons for an air conditioner.
            // One number column across all three would compare 190 litres with 1.5 tons.
            dataType: AttributeDataType.TEXT,
            isFilterable: true,
          },
          {
            ...
            labelTe: 'స్టార్ రేటింగ్',
            labelHi: 'स्टार रेटिंग',
            dataType: AttributeDataType.SELECT,
            options: [
