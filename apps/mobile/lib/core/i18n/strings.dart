...
class Strings {
  ...
  static const Map<AppLocaleOption, Map<String, String>> _catalogue = {
    ...
    AppLocaleOption.te: {
      ...
      'search.businessVerified': 'ధృవీకరించబడింది',
      'search.businessClaim': 'దీన్ని క్లెయిమ్ చేయండి',
      'search.noBusinessesMatch': 'ఈ ఫిల్టర్‌లకు సరిపోయే వ్యాపారాలు ఇంకా లేవు.',
      'area.title': '{city}లో మీ దగ్గర ఏముంది',
      ...
      'area.mobility': 'రవాణా',
      'area.home': 'ఇల్లు & మరమ్మతు',
      'area.jobs': 'ఉద్యోగాలు',
      'area.events': 'కార్యక్రమాలు',
      'area.rentals': 'అద్దెలు',
      'area.deals': 'ఆఫర్లు',
      'area.businesses': 'వ్యాపారాలు',
      'area.play': 'ఆట',
      'area.pets': 'పెంపుడు జంతువులు',
      'news.kicker': 'లోకల్ నౌ',
      'news.title': '{city} చుట్టూ తాజా వార్తలు',
      'jobs.kicker': 'సమీపంలో ఉద్యోగాలు',
      'jobs.title': '{city}లో ఉద్యోగాలు',
