...
class Strings {
  ...
  static const Map<AppLocaleOption, Map<String, String>> _catalogue = {
    AppLocaleOption.en: {
      ...
      'listing.safetyHint': 'Inspect in person, meet in public and pay only when you are satisfied.',
    ...
    AppLocaleOption.te: {
      ...
      'listing.safetyHint': 'వస్తువును స్వయంగా పరిశీలించండి, బహిరంగ ప్రదేశంలో కలవండి, సంతృప్తి చెందిన తర్వాతే చెల్లించండి.',
    ...
    AppLocaleOption.hi: {
      ...
      'listing.safetyHint': 'सामान खुद जाँचें, सार्वजनिक जगह पर मिलें और संतुष्ट होने के बाद ही भुगतान करें।',
