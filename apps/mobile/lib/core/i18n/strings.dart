...
class Strings {
  ...
  static const Map<AppLocaleOption, Map<String, String>> _catalogue = {
    AppLocaleOption.en: {
      ...
      'nav.account': 'Account',
      'common.back': 'Back',
      'cityGuide.kicker': 'The LocZ city guide',
      'cityGuide.exploreCity': 'Explore {city}',
      'cityGuide.homeHint': 'History, landmarks and useful things nearby',
      'cityGuide.aboutKicker': 'Meet the city',
      'cityGuide.aboutTitle': 'About {city}',
      'cityGuide.famousKicker': 'Known and loved for',
      'cityGuide.famousTitle': 'What makes {city} special',
      'cityGuide.landmarksKicker': 'See the city',
      'cityGuide.landmarksTitle': 'Landmarks and places in {city}',
      'cityGuide.locationKicker': 'Find your bearings',
      'cityGuide.locationTitle': 'Where is {city}?',
      'cityGuide.openMap': 'Open interactive map',
      'cityGuide.mapCaveat':
          'Map boundaries are indicative and do not represent a position on disputed borders.',
      'cityGuide.guideKicker': 'Know before you go',
      'cityGuide.guideTitle': 'The {city} city guide',
      'cityGuide.population': 'Population',
      'cityGuide.cityTier': 'City tier',
      'cityGuide.region': 'Region',
      'cityGuide.climate': 'Climate',
      'cityGuide.directoryTitle': 'Businesses near you in {city}',
      'cityGuide.directoryIntro':
          'Find trusted shops, services, work and everyday essentials nearby.',
      'cityGuide.exploreLocal': 'Explore nearby',
      'cityGuide.loadFailed': 'We could not load this city guide right now.',
      // Explore (browse everything LocZ can find, grouped). te/hi fall back to English.
      'explore.title': 'Explore LocZ',
      'explore.subtitle': 'Everything useful around you, grouped',
      'explore.searchHint': 'What do you need nearby?',
      'explore.group.discover': 'Discover',
      'explore.group.buySave': 'Buy & Save',
      'explore.group.workEarn': 'Work & Earn',
      'explore.group.homeProperty': 'Home & Property',
      'explore.group.services': 'Services',
      'explore.group.community': 'Community',
      ...
      // Alerts hub (§20). te/hi fall back to English.
      'alerts.title': 'Alerts',
      'alerts.subtitle': 'What LocZ is watching for you',
      'alerts.notifications': 'Notifications',
      'alerts.notificationsHint': 'Replies, responses and updates',
      'alerts.savedSearches': 'Saved searches',
      'alerts.savedSearchesHint': 'Get told when a match appears nearby',
      'nav.saved': 'Saved',
      'nav.signIn': 'Sign in',
      ...
      'location.findArea': 'Find your area',
      'location.gpsOrPincode': 'Use GPS or enter your pincode',
      ...
      'business.descriptionGenerated':
          'Written by LocZ from the category and area, not by the business.',
      'business.call': 'Call',
      'business.directions': 'Directions',
      'business.claim': 'Is this your business? Claim it',
      'business.loadFailed': 'Could not load this business',
      'business.about': 'About this place',
      'business.similarTitle': 'Similar places nearby',
      'business.verified': 'Verified',
      'business.details': 'Visit details',
      'business.address': 'Address',
      'business.hours': 'Opening hours',
      'business.website': 'Website',
      'business.claimHint':
          'Confirm ownership to add accurate hours, contact details and services.',
      'business.sparseTitle': 'Local details are still being gathered',
      'business.sparseHint':
          'We currently know only this place’s name and category. More useful details will appear after they are confirmed.',
      'business.attributionTitle': 'Directory data source',
      'search.businessesTitle': 'Shops and businesses',
      'search.businessCount': '{count} found',
      'search.businessClaimed': 'Claimed by owner',
      'search.businessUnclaimed': 'From the local directory',
      'search.businessVerified': 'Verified',
      'search.businessClaim': 'Claim this',
      'search.noBusinessesMatch': 'No businesses match these filters yet.',
      'area.title': "What's near you in {city}",
      'area.kicker': 'Around you',
      'area.food': 'Food',
      'area.health': 'Health',
      'area.services': 'Services',
      'area.shopping': 'Shopping',
      'area.mobility': 'Mobility',
      'area.home': 'Home & repair',
      'area.jobs': 'Jobs',
      'area.events': 'Events',
      'area.rentals': 'Rentals',
      'area.deals': 'Deals',
      'area.businesses': 'Businesses',
      'area.local-now': 'Local Now',
      'area.marketplace': 'Marketplace',
      'area.play': 'Play',
      'area.pets': 'Pets',
      'news.kicker': 'Local now',
      'news.title': 'Latest around {city}',
      'news.loadFailed': 'Could not load this story.',
      'news.sourcesLabel': 'REPORTED BY',
      'jobs.kicker': 'Work nearby',
      'jobs.title': 'Jobs in {city}',
      'alerts.localTitle': 'Local alerts',
      'search.viewProfile': 'View profile',
      'search.listingCount': '{count} listings',
      ...
      'feed.whatsNearYou': "What's near you?",
      'feed.discoverySummary': '{count} useful finds around {city}',
      'feed.viewAll': 'View all',
      'feed.exploreArea': 'Explore',
      'feed.backToExplore': 'Explore',
      'feed.filters': 'Filters',
      'feed.nearest': 'Nearest',
      'feed.latest': 'Latest',
      ...
      'type.RENTAL': 'Rental',
      'type.EVENT': 'Event',
      'type.BUYER_REQUIREMENT': 'Wanted',
      'type.BUSINESS_LISTING': 'Business',
      'listing.free': 'Free',
      'listing.negotiable': 'Negotiable',
      'listing.contactSeller': 'Message seller',
      'listing.showPhone': 'Show phone number',
      'listing.enquiryTitle': 'Ask the seller',
      'listing.enquiryPrompt': 'Hi, is this still available?',
      'listing.enquiryPrivacy': 'Keep the conversation in LocZ. Your phone number stays private.',
      ...
      'notifications.emptyHint': 'Listing updates, replies and safety decisions will appear here.',
      ...
      'chats.signedOutTitle': 'Your local conversations, in one place',
      'chats.signedOutBody': 'Sign in to message sellers and return to every conversation safely.',
      'chats.emptyBody':
          'Open a listing and message the seller. Your conversations will appear here.',
      'chats.threadEmptyTitle': 'Start the conversation',
      'chats.threadEmptyBody': 'Ask a clear question about the listing to get a useful reply.',
      'chats.privateHint': 'Messages stay inside LocZ',
      ...
      'verifyPhone.title': 'Confirm your mobile number',
      'verifyPhone.intro':
          'A confirmed number helps you claim a business and shows buyers they can reach you.',
      'verifyPhone.invalidPhone': 'Enter a valid 10-digit mobile number.',
      'verifyPhone.invalidCode': 'Enter the six-digit code.',
      'verifyPhone.wrongCode': 'That code is not right. Check it and try again.',
      'verifyPhone.tooMany': 'Too many attempts. Wait a few minutes and try again.',
      'verifyPhone.failed': 'We could not confirm that number. Try again.',
      'verifyPhone.inUse': 'That number is already on another LocZ account.',
      'verifyPhone.codeLabel': 'Six-digit code',
      'verifyPhone.codeHint': 'Sent by SMS. It expires in a few minutes.',
      'verifyPhone.differentNumber': 'Use a different number',
      'verifyPhone.confirmed': '{phone} is confirmed.',
      'verifyPhone.trust': 'Your number is never made public without your choice.',
      ...
      'requirements.fulfilledConfirmTitle': 'Close this requirement?',
      'requirements.fulfilledConfirmHint': 'Sellers will no longer be able to send new answers.',
    ...
    AppLocaleOption.te: {
      ...
      'nav.account': 'ఖాతా',
      'common.back': 'వెనుకకు',
      'cityGuide.kicker': 'LocZ నగర మార్గదర్శిని',
      'cityGuide.exploreCity': '{city}ను తెలుసుకోండి',
      'cityGuide.homeHint': 'చరిత్ర, ప్రముఖ ప్రదేశాలు, సమీప ఉపయోగకరమైనవి',
      'cityGuide.aboutKicker': 'నగరాన్ని తెలుసుకోండి',
      'cityGuide.aboutTitle': '{city} గురించి',
      'cityGuide.famousKicker': 'ప్రసిద్ధి చెందినవి',
      'cityGuide.famousTitle': '{city} ప్రత్యేకత ఏమిటి',
      'cityGuide.landmarksKicker': 'నగరాన్ని చూడండి',
      'cityGuide.landmarksTitle': '{city}లో ప్రముఖ ప్రదేశాలు',
      'cityGuide.locationKicker': 'దిశ తెలుసుకోండి',
      'cityGuide.locationTitle': '{city} ఎక్కడ ఉంది?',
      'cityGuide.openMap': 'ఇంటరాక్టివ్ మ్యాప్ తెరవండి',
      'cityGuide.mapCaveat':
          'మ్యాప్ సరిహద్దులు సూచన మాత్రమే; వివాదాస్పద సరిహద్దులపై ఏ వైఖరినీ సూచించవు.',
      'cityGuide.guideKicker': 'వెళ్లే ముందు తెలుసుకోండి',
      'cityGuide.guideTitle': '{city} నగర మార్గదర్శిని',
      'cityGuide.population': 'జనాభా',
      'cityGuide.cityTier': 'నగర స్థాయి',
      'cityGuide.region': 'ప్రాంతం',
      'cityGuide.climate': 'వాతావరణం',
      'cityGuide.directoryTitle': '{city}లో మీ సమీప వ్యాపారాలు',
      'cityGuide.directoryIntro':
          'సమీపంలోని విశ్వసనీయ దుకాణాలు, సేవలు, ఉద్యోగాలు, రోజువారీ అవసరాలను కనుగొనండి.',
      'cityGuide.exploreLocal': 'సమీపంలో వెతకండి',
      'cityGuide.loadFailed': 'ఈ నగర మార్గదర్శిని ఇప్పుడు లోడ్ చేయలేకపోయాం.',
      ...
      'location.findArea': 'మీ ప్రాంతాన్ని కనుగొనండి',
      'location.gpsOrPincode': 'GPS వాడండి లేదా పిన్‌కోడ్ నమోదు చేయండి',
      ...
      'business.claimed': 'యజమాని క్లెయిమ్ చేసి తాజాగా ఉంచుతున్నారు.',
      'business.unclaimed': 'స్థానిక డైరెక్టరీ నుండి. ఈ వివరాలను ఇంకా ఎవరూ ధృవీకరించలేదు.',
      'business.descriptionGenerated': 'వర్గం మరియు ప్రాంతం ఆధారంగా LocZ రాసింది, వ్యాపారం కాదు.',
      'business.call': 'కాల్ చేయండి',
      'business.directions': 'దారి చూపించు',
      'business.claim': 'ఇది మీ వ్యాపారమా? క్లెయిమ్ చేయండి',
      'business.loadFailed': 'ఈ వ్యాపారాన్ని లోడ్ చేయలేకపోయాము',
      'business.about': 'ఈ ప్రదేశం గురించి',
      'business.similarTitle': 'దగ్గరలో ఇలాంటివి',
      'business.verified': 'వెరిఫైడ్',
      'business.details': 'సందర్శన వివరాలు',
      'business.address': 'చిరునామా',
      'business.hours': 'తెరిచి ఉండే సమయాలు',
      'business.website': 'వెబ్‌సైట్',
      'business.claimHint':
          'ఖచ్చితమైన సమయాలు, సంప్రదింపు వివరాలు మరియు సేవలను జోడించడానికి యాజమాన్యాన్ని నిర్ధారించండి.',
      'business.sparseTitle': 'స్థానిక వివరాలు ఇంకా సేకరిస్తున్నాము',
      'business.sparseHint':
          'ప్రస్తుతం ఈ ప్రదేశం పేరు మరియు వర్గం మాత్రమే మాకు తెలుసు. నిర్ధారించిన తర్వాత మరిన్ని ఉపయోగకరమైన వివరాలు కనిపిస్తాయి.',
      'business.attributionTitle': 'డైరెక్టరీ డేటా మూలం',
      'search.businessesTitle': 'దుకాణాలు మరియు వ్యాపారాలు',
      'search.businessCount': '{count} దొరికాయి',
      'search.businessClaimed': 'యజమాని క్లెయిమ్ చేశారు',
      'search.businessUnclaimed': 'స్థానిక డైరెక్టరీ నుండి',
      'search.businessVerified': 'వెరిఫైడ్',
      'search.businessClaim': 'క్లెయిమ్ చేయండి',
      'search.noBusinessesMatch': 'ఈ ఫిల్టర్‌లకు బిజినెస్‌లు లేవు.',
      'area.title': '{city}లో మీ చుట్టూ ఏముంది',
      'area.kicker': 'మీ చుట్టూ',
      'area.food': 'ఫుడ్',
      'area.health': 'హెల్త్',
      'area.services': 'సర్వీసెస్',
      'area.shopping': 'షాపింగ్',
      'area.mobility': 'వెహికల్స్',
      'area.home': 'హోమ్ & రిపేర్',
      'area.jobs': 'జాబ్స్',
      'area.events': 'ఈవెంట్స్',
      'area.rentals': 'రెంటల్స్',
      'area.deals': 'డీల్స్',
      'area.businesses': 'బిజినెస్‌లు',
      'area.news': 'న్యూస్',
      'area.alerts': 'అలర్ట్స్',
      'area.local-now': 'లోకల్ నౌ',
      'area.marketplace': 'మార్కెట్‌ప్లేస్',
      'area.play': 'స్పోర్ట్స్',
      'area.pets': 'పెట్స్',
      'news.kicker': 'లోకల్ నౌ',
      'news.title': '{city}లో లేటెస్ట్',
      'news.loadFailed': 'ఈ వార్తను లోడ్ చేయలేకపోయాం.',
      'news.sourcesLabel': 'మూలం',
      'jobs.kicker': 'దగ్గర్లో జాబ్స్',
      'jobs.title': '{city}లో జాబ్స్',
      'alerts.localTitle': 'లోకల్ అలర్ట్స్',
      'search.viewProfile': 'ప్రొఫైల్ చూడండి',
      'search.listingCount': '{count} ప్రకటనలు',
      ...
      'listing.enquiryTitle': 'విక్రేతను అడగండి',
      'listing.enquiryPrompt': 'హాయ్, ఇది ఇంకా అందుబాటులో ఉందా?',
      'listing.enquiryPrivacy': 'సంభాషణను LocZలోనే కొనసాగించండి. మీ ఫోన్ నంబర్ గోప్యంగా ఉంటుంది.',
      ...
      'notifications.emptyHint':
          'ప్రకటన అప్‌డేట్లు, సమాధానాలు మరియు భద్రతా నిర్ణయాలు ఇక్కడ కనిపిస్తాయి.',
      'notifications.errorHint':
          'మీ అప్‌డేట్లను లోడ్ చేయలేకపోయాము. కనెక్షన్‌ను తనిఖీ చేసి మళ్లీ ప్రయత్నించండి.',
      ...
      'chats.empty': 'ఇంకా సంభాషణలు లేవు',
      'chats.signedOutTitle': 'మీ స్థానిక సంభాషణలన్నీ ఒకేచోట',
      'chats.signedOutBody':
          'విక్రేతలకు సందేశం పంపడానికి మరియు ప్రతి సంభాషణకు సురక్షితంగా తిరిగి రావడానికి సైన్ ఇన్ చేయండి.',
      'chats.emptyBody':
          'ఒక ప్రకటనను తెరిచి విక్రేతకు సందేశం పంపండి. మీ సంభాషణలు ఇక్కడ కనిపిస్తాయి.',
      'chats.threadEmptyTitle': 'సంభాషణను ప్రారంభించండి',
      'chats.threadEmptyBody':
          'ఉపయోగకరమైన సమాధానం పొందడానికి ప్రకటన గురించి స్పష్టమైన ప్రశ్న అడగండి.',
      'chats.privateHint': 'సందేశాలు LocZలోనే ఉంటాయి',
      'chats.messageHint': 'సందేశం రాయండి…',
      'chats.send': 'పంపండి',
      'account.appearance': 'రూపం',
      'account.confirmPhone': 'మొబైల్ నంబర్ ధృవీకరించండి',
      'verifyPhone.title': 'మీ మొబైల్ నంబర్‌ను ధృవీకరించండి',
      'verifyPhone.intro':
          'ధృవీకరించిన నంబర్‌తో వ్యాపారాన్ని క్లెయిమ్ చేయవచ్చు మరియు కొనుగోలుదారులు మిమ్మల్ని సంప్రదించగలరని తెలుస్తుంది.',
      'verifyPhone.invalidPhone': 'చెల్లుబాటు అయ్యే 10 అంకెల మొబైల్ నంబర్ ఇవ్వండి.',
      'verifyPhone.invalidCode': 'ఆరు అంకెల కోడ్‌ను ఇవ్వండి.',
      'verifyPhone.wrongCode': 'ఆ కోడ్ సరైనది కాదు. తనిఖీ చేసి మళ్లీ ప్రయత్నించండి.',
      'verifyPhone.tooMany': 'చాలా ప్రయత్నాలు చేశారు. కొన్ని నిమిషాలు ఆగి మళ్లీ ప్రయత్నించండి.',
      'verifyPhone.failed': 'ఆ నంబర్‌ను ధృవీకరించలేకపోయాము. మళ్లీ ప్రయత్నించండి.',
      'verifyPhone.inUse': 'ఆ నంబర్ ఇప్పటికే మరో LocZ ఖాతాలో ఉంది.',
      'verifyPhone.codeLabel': 'ఆరు అంకెల కోడ్',
      'verifyPhone.codeHint': 'SMS ద్వారా పంపబడింది. కొన్ని నిమిషాల్లో గడువు ముగుస్తుంది.',
      'verifyPhone.differentNumber': 'వేరే నంబర్ ఉపయోగించండి',
      'verifyPhone.confirmed': '{phone} ధృవీకరించబడింది.',
      'verifyPhone.trust': 'మీ ఎంపిక లేకుండా మీ నంబర్‌ను బహిరంగంగా చూపించము.',
      ...
      'account.moreActions': 'మరిన్ని చర్యలు',
      'account.status.DRAFT': 'ముసాయిదా',
      'account.status.PUBLISHED': 'ప్రచురించబడింది',
      'account.status.PENDING_REVIEW': 'సమీక్షలో ఉంది',
      'account.status.PAUSED': 'నిలిపివేయబడింది',
      'account.status.SOLD': 'అమ్ముడైంది',
      'account.status.EXPIRED': 'గడువు ముగిసింది',
      'account.status.REJECTED': 'తిరస్కరించబడింది',
      'account.status.REMOVED': 'తొలగించబడింది',
      ...
      'requirements.fulfilledConfirmTitle': 'ఈ అవసరాన్ని ముగించాలా?',
      'requirements.fulfilledConfirmHint': 'విక్రేతలు ఇకపై కొత్త సమాధానాలు పంపలేరు.',
    ...
    AppLocaleOption.hi: {
      ...
      'nav.account': 'खाता',
      'common.back': 'वापस',
      'cityGuide.kicker': 'LocZ शहर मार्गदर्शिका',
      'cityGuide.exploreCity': '{city} को जानें',
      'cityGuide.homeHint': 'इतिहास, प्रमुख स्थल और पास की उपयोगी चीज़ें',
      'cityGuide.aboutKicker': 'शहर को जानें',
      'cityGuide.aboutTitle': '{city} के बारे में',
      'cityGuide.famousKicker': 'इन चीज़ों के लिए प्रसिद्ध',
      'cityGuide.famousTitle': '{city} को क्या खास बनाता है',
      'cityGuide.landmarksKicker': 'शहर देखें',
      'cityGuide.landmarksTitle': '{city} के प्रमुख स्थल',
      'cityGuide.locationKicker': 'अपनी दिशा जानें',
      'cityGuide.locationTitle': '{city} कहाँ है?',
      'cityGuide.openMap': 'इंटरैक्टिव मानचित्र खोलें',
      'cityGuide.mapCaveat':
          'मानचित्र सीमाएँ संकेतात्मक हैं और विवादित सीमाओं पर किसी रुख का प्रतिनिधित्व नहीं करतीं।',
      'cityGuide.guideKicker': 'जाने से पहले जानें',
      'cityGuide.guideTitle': '{city} शहर मार्गदर्शिका',
      'cityGuide.population': 'जनसंख्या',
      'cityGuide.cityTier': 'शहर श्रेणी',
      'cityGuide.region': 'क्षेत्र',
      'cityGuide.climate': 'जलवायु',
      'cityGuide.directoryTitle': '{city} में आपके पास के व्यवसाय',
      'cityGuide.directoryIntro':
          'आस-पास की भरोसेमंद दुकानें, सेवाएँ, काम और रोज़मर्रा की ज़रूरतें खोजें।',
      'cityGuide.exploreLocal': 'आस-पास खोजें',
      'cityGuide.loadFailed': 'यह शहर मार्गदर्शिका अभी लोड नहीं हो सकी।',
      'nav.saved': 'सहेजे गए',
      'nav.signIn': 'साइन इन',
      'nav.signOut': 'साइन आउट',
      'location.change': 'बदलें',
      'location.useCurrent': 'मेरा वर्तमान स्थान',
      'location.findArea': 'अपना क्षेत्र खोजें',
      'location.gpsOrPincode': 'GPS का उपयोग करें या पिनकोड डालें',
      ...
      'business.claimed': 'मालिक ने दावा किया और अद्यतन रखते हैं।',
      'business.unclaimed':
          'स्थानीय डायरेक्टरी से। इन विवरणों की अभी तक किसी ने पुष्टि नहीं की है।',
      'business.descriptionGenerated': 'श्रेणी और क्षेत्र से LocZ ने लिखा, व्यवसाय ने नहीं।',
      'business.call': 'कॉल करें',
      'business.directions': 'दिशा-निर्देश',
      'business.claim': 'क्या यह आपका व्यवसाय है? दावा करें',
      'business.loadFailed': 'यह व्यवसाय लोड नहीं हो सका',
      'business.about': 'इस जगह के बारे में',
      'business.similarTitle': 'आसपास ऐसी ही जगहें',
      'business.verified': 'वेरिफाइड',
      'business.details': 'आने-जाने की जानकारी',
      'business.address': 'पता',
      'business.hours': 'खुलने का समय',
      'business.website': 'वेबसाइट',
      'business.claimHint':
          'सही समय, संपर्क विवरण और सेवाएँ जोड़ने के लिए मालिकाना हक़ पुष्ट करें।',
      'business.sparseTitle': 'स्थानीय जानकारी अभी जुटाई जा रही है',
      'business.sparseHint':
          'अभी हमें केवल इस जगह का नाम और श्रेणी पता है। पुष्टि होने के बाद अधिक उपयोगी जानकारी दिखाई देगी।',
      'business.attributionTitle': 'डायरेक्टरी डेटा स्रोत',
      'search.businessesTitle': 'दुकानें और व्यवसाय',
      'search.businessCount': '{count} मिले',
      'search.businessClaimed': 'मालिक ने दावा किया',
      'search.businessUnclaimed': 'स्थानीय डायरेक्टरी से',
      'search.businessVerified': 'सत्यापित',
      'search.businessClaim': 'इसे क्लेम करें',
      'search.noBusinessesMatch': 'इन फ़िल्टर से मेल खाने वाले व्यवसाय अभी नहीं हैं।',
      'area.title': '{city} में आपके पास क्या है',
      'area.kicker': 'आपके आसपास',
      'area.food': 'खाना',
      'area.health': 'स्वास्थ्य',
      'area.services': 'सेवाएं',
      'area.shopping': 'शॉपिंग',
      'area.mobility': 'परिवहन',
      'area.home': 'घर व मरम्मत',
      'area.jobs': 'नौकरियां',
      'area.events': 'आयोजन',
      'area.rentals': 'किराया',
      'area.deals': 'ऑफर',
      'area.businesses': 'व्यवसाय',
      'area.news': 'न्यूज़',
      'area.alerts': 'अलर्ट',
      'area.local-now': 'लोकल नाउ',
      'area.marketplace': 'मार्केटप्लेस',
      'area.play': 'खेल',
      'area.pets': 'पालतू',
      'news.kicker': 'लोकल नाउ',
      'news.title': '{city} के आसपास ताज़ा',
      'news.loadFailed': 'यह खबर लोड नहीं हो सकी।',
      'news.sourcesLabel': 'स्रोत',
      'jobs.kicker': 'आसपास काम',
      'jobs.title': '{city} में नौकरियां',
      'alerts.localTitle': 'स्थानीय अलर्ट',
      'search.viewProfile': 'प्रोफ़ाइल देखें',
      'search.listingCount': '{count} लिस्टिंग',
      ...
      'listing.enquiryTitle': 'विक्रेता से पूछें',
      'listing.enquiryPrompt': 'नमस्ते, क्या यह अभी उपलब्ध है?',
      'listing.enquiryPrivacy': 'बातचीत LocZ में रखें। आपका फ़ोन नंबर निजी रहेगा।',
      ...
      'notifications.emptyHint': 'विज्ञापन अपडेट, जवाब और सुरक्षा से जुड़े फैसले यहाँ दिखाई देंगे।',
      'notifications.errorHint': 'आपके अपडेट लोड नहीं हो सके। कनेक्शन जाँचें और फिर कोशिश करें।',
      ...
      'chats.title': 'संदेश',
      'chats.empty': 'अभी कोई बातचीत नहीं',
      'chats.signedOutTitle': 'आपकी स्थानीय बातचीत, एक ही जगह',
      'chats.signedOutBody':
          'विक्रेताओं को संदेश भेजने और हर बातचीत पर सुरक्षित लौटने के लिए साइन इन करें।',
      'chats.emptyBody': 'कोई विज्ञापन खोलकर विक्रेता को संदेश भेजें। आपकी बातचीत यहाँ दिखाई देगी।',
      'chats.threadEmptyTitle': 'बातचीत शुरू करें',
      'chats.threadEmptyBody': 'उपयोगी जवाब पाने के लिए विज्ञापन के बारे में स्पष्ट सवाल पूछें।',
      'chats.privateHint': 'संदेश LocZ के अंदर रहते हैं',
      'chats.messageHint': 'संदेश लिखें…',
      'chats.send': 'भेजें',
      'account.appearance': 'दिखावट',
      'account.confirmPhone': 'मोबाइल नंबर पुष्ट करें',
      'verifyPhone.title': 'अपना मोबाइल नंबर पुष्ट करें',
      'verifyPhone.intro':
          'पुष्ट नंबर से आप व्यवसाय पर दावा कर सकते हैं और खरीदार जान पाते हैं कि आपसे संपर्क हो सकता है।',
      'verifyPhone.invalidPhone': 'सही 10 अंकों का मोबाइल नंबर डालें।',
      'verifyPhone.invalidCode': 'छह अंकों का कोड डालें।',
      'verifyPhone.wrongCode': 'यह कोड सही नहीं है। जाँचकर फिर कोशिश करें।',
      'verifyPhone.tooMany': 'बहुत ज़्यादा कोशिशें हुईं। कुछ मिनट रुककर फिर कोशिश करें।',
      'verifyPhone.failed': 'यह नंबर पुष्ट नहीं हो सका। फिर कोशिश करें।',
      'verifyPhone.inUse': 'यह नंबर पहले से किसी दूसरे LocZ खाते में है।',
      'verifyPhone.codeLabel': 'छह अंकों का कोड',
      'verifyPhone.codeHint': 'SMS से भेजा गया है। यह कुछ मिनट में समाप्त हो जाएगा।',
      'verifyPhone.differentNumber': 'दूसरा नंबर इस्तेमाल करें',
      'verifyPhone.confirmed': '{phone} पुष्ट हो गया है।',
      'verifyPhone.trust': 'आपकी अनुमति के बिना आपका नंबर सार्वजनिक नहीं किया जाता।',
      ...
      'account.moreActions': 'और कार्रवाइयाँ',
      'account.status.DRAFT': 'ड्राफ़्ट',
      'account.status.PUBLISHED': 'प्रकाशित',
      'account.status.PENDING_REVIEW': 'समीक्षा में',
      'account.status.PAUSED': 'रोका गया',
      'account.status.SOLD': 'बिक गया',
      'account.status.EXPIRED': 'समाप्त',
      'account.status.REJECTED': 'अस्वीकृत',
      'account.status.REMOVED': 'हटाया गया',
      ...
      'requirements.fulfilledConfirmTitle': 'इस ज़रूरत को बंद करें?',
      'requirements.fulfilledConfirmHint': 'विक्रेता अब नए जवाब नहीं भेज पाएँगे।',
