  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<SellerProfile>(
        future: ref.watch(listingRepositoryProvider).sellerProfile(userId),
        builder: (context, snapshot) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    OutlinedButton.icon(
                      onPressed: () => ref.invalidate(listingRepositoryProvider),
          ...
          return ListView(
            ...
            children: [
              ...
              if (profile.responseRate != null || profile.medianResponseMinutes != null) ...[
                const SizedBox(height: LoczSpacing.x4),
                Card(
                  child: Padding(
                    padding: const EdgeInsets.all(LoczSpacing.x4),
                    child: Column(
                      ...
                      children: [
                        Text(
                          strings('sellerProfile.reliability'),
                        ...
                        if (profile.medianResponseMinutes != null)
                          _TrustRow(
                            ...
                            strings('sellerProfile.responseTime', {
                              'minutes': profile.medianResponseMinutes!.round(),
                            }),
                          ),
                      ],
                    ),
